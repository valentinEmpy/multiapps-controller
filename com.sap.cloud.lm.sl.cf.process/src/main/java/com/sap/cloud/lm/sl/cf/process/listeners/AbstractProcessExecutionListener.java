...
public abstract class AbstractProcessExecutionListener implements ExecutionListener {
    ...
    protected void addHistoricOperationEvent(DelegateExecution context, EventType type) {
        HistoricOperationEvent historicOperationEvent = new HistoricOperationEvent.Builder(
            StepsUtil.getCorrelationId(context), type).build();
