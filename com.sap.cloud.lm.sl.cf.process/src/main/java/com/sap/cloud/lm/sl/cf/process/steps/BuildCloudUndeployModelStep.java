...
public class BuildCloudUndeployModelStep extends SyncFlowableStep {
    ...
    protected StepPhase executeStep(ExecutionWrapper execution) {
        ...
        List<CloudApplication> appsToUndeploy = computeAppsToUndeploy(deployedAppsToUndeploy, deployedApps);
    ...
    private boolean shouldUndeployApp(List<DeployedMtaApplication> applicationsToUndeploy, CloudApplication app) {
        return applicationsToUndeploy.stream()
                                     .anyMatch(application -> application.getName()
                                                                         .equals(app.getName()));
    }
