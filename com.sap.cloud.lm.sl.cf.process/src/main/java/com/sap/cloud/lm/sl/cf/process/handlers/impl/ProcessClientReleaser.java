...
public class ProcessClientReleaser extends FlowableEngineEventHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProcessClientReleaser.class);
    private FileService fileService;
    private CloudControllerClientProvider clientProvider;

    public ProcessClientReleaser(FileService fileService, CloudControllerClientProvider clientProvider) {
    ...
    protected void handleInternal(FlowableEvent event) {
        ...
        executeSafely(processDataCleaner::removeClientForProcess);
    }
