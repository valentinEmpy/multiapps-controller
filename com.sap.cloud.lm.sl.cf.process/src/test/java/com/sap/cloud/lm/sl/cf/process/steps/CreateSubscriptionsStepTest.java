...
// @formatter:on
    ...
    private void prepareSubscriptionService() throws Exception {
        ...
        for (int i = 0; i < input.subscriptionsToUpdate.size(); i++) {
            ...
            ConfigurationSubscriptionQuery queryMock = new MockBuilder<>(configurationSubscriptionQuery,
                                                                         ConfigurationSubscriptionQuery.class).on(query -> query.appName(subscription.getAppName()))
