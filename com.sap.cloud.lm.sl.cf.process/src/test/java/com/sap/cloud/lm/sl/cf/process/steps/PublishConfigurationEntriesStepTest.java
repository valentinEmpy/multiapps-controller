...
// @formatter:on
    ...
    public void prepareConfigurationEntryService() throws Exception {
        ...
        for (ConfigurationEntry entry : exisitingConfigurationEntries) {
            ConfigurationEntryQuery entryQueryMock = new MockBuilder<>(configurationEntryQuery,
                                                                       ConfigurationEntryQuery.class).on(query -> query.providerNid(entry.getProviderNid()))
