...
// @formatter:on
    ...
    private static class GetRequestTest extends TestCase<GetRequestTestInput> {
        ...
        protected void setUp() throws Exception {
            ...
            // ConfigurationEntryQuery mockQuery = new MockBuilder<>(configurationEntryQuery,
            // ConfigurationEntryQuery.class).on(query -> query.id(input.getId()))
            // .build();
    ...
    private static class DeleteRequestTest extends TestCase<DeleteRequestTestInput> {
        ...
        protected void setUp() throws Exception {
            MockitoAnnotations.initMocks(this);
            when(configurationEntryService.createQuery()).thenReturn(configurationEntryQuery);
            ConfigurationEntryQuery inputQuery = new MockBuilder<>(configurationEntryQuery,
                                                                   ConfigurationEntryQuery.class).on(queryMock -> queryMock.id(input.getId()))
                                                                                                 .build();
