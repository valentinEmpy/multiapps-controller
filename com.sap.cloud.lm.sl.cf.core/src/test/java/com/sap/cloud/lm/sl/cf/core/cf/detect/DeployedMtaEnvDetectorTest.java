...
public class DeployedMtaEnvDetectorTest {
    ...
    @InjectMocks
    private DeployedMtaEnvDetector deployedMtaEnvDetector = new DeployedMtaEnvDetector();
...
// @formatter:on
    ...
    public void testGetAllDeployedMtas(String appsResourceLocation, Expectation expectation) throws IOException {
        ...
        prepareClient(apps);
        tester.test(() -> deployedMtaEnvDetector.getAllDeployedMtas(client), expectation);
    }
