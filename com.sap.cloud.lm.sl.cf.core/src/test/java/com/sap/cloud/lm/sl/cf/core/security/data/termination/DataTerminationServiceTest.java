...
// @formatter:on
    ...
    private void initializeServiceMocks(List<ConfigurationSubscription> subscriptions, List<ConfigurationEntry> configurationEntries,
        ...
        ConfigurationSubscriptionQuery configurationSubscriptionQueryMock = new MockBuilder<>(configurationSubscriptionQuery,
                                                                                              ConfigurationSubscriptionQuery.class).on(query -> query.spaceId(deletedSpace))
                                                                                                                                   .build();
        doReturn(subscriptions).when(configurationSubscriptionQueryMock)
                               .list();

        ConfigurationEntryQuery configurationEntryQueryMock = new MockBuilder<>(configurationEntryQuery,
                                                                                ConfigurationEntryQuery.class).on(query -> query.spaceId(deletedSpace))
                                                                                                              .build();
