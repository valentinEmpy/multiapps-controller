...
public class ConfigurationSubscriptionServiceTest {
    ...
    private ConfigurationSubscriptionService createConfigurationSubscriptionService() {
        ...
        ConfigurationSubscriptionFactory configurationSubscriptionFactory = new ConfigurationSubscriptionFactory();
        configurationSubscriptionService.subscriptionFactory = configurationSubscriptionFactory;
