...
public class DeployedMtaDetectorTest {
    ...
    private MtaMetadataParser serviceMetadataFieldExtractor = Mockito.spy(MtaMetadataParser.class);
    ...
    @InjectMocks
    private DeployedMtaDetector detector = new DeployedMtaDetector();
...
// @formatter:off
    ...
    @ParameterizedTest
    @MethodSource
    public void testDetectAllApplications(String appsResourceLocation, String servicesResourceLocation, Expectation expectation)
        throws IOException {
