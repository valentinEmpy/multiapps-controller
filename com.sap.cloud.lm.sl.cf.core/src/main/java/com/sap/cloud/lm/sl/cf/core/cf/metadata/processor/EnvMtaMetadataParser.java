...
public class EnvMtaMetadataParser {
    ...
    public DeployedMtaApplication parseDeployedMtaApplication(CloudApplication application) {
        ...
        List<DeployedMtaService> services = parseDeployedMtaServices(application);
    ...
    private List<DeployedMtaService> parseDeployedMtaServices(CloudApplication application) {
        return parseServices(application).stream()
                                         .map(name -> ImmutableDeployedMtaService.builder()
                                                                                 .serviceName(name)
                                                                                 .build())
