...
public class ConfigurationSubscriptionFactory
    extends AbstractPersistenceObjectFactory<ConfigurationSubscription, ConfigurationSubscriptionDto> {

    @Override
    protected ConfigurationSubscription fromNonNullDto(ConfigurationSubscriptionDto dto) {
        try {
            ...
            return new ConfigurationSubscription(dto.getPrimaryKey(), dto.getMtaId(), dto.getSpaceId(), dto.getAppName(), parsedFilter,
    ...
    @Override
    protected ConfigurationSubscriptionDto nonNullObjectToDto(ConfigurationSubscription subscription) {
        String filter = null;
        ...
        return new ConfigurationSubscriptionDto(0, mtaId, spaceId, appName, filter, module, resourceName, resourceProperties);
    }
