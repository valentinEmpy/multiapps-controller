...
public class ConfigurationEntryDtoDao extends AbstractDtoDao<ConfigurationEntryDto, Long> {
    ...
    protected NotFoundException getNotFoundException(Long id) {
        return new NotFoundException(Messages.CONFIGURATION_ENTRY_NOT_FOUND, id);
    }

    @Override
    protected ConflictException getConflictException(ConfigurationEntryDto entry) {
        return new ConflictException(Messages.CONFIGURATION_ENTRY_ALREADY_EXISTS, entry.getProviderNid(), entry.getProviderId(),
