...
public class HistoricOperationEventDtoDao extends AbstractDtoDao<HistoricOperationEventDto, Long> {
    ...
    protected NotFoundException getNotFoundException(Long id) {
        return new NotFoundException(Messages.HISTORIC_OPERATION_EVENT_NOT_FOUND, id);
    }

    @Override
    protected ConflictException getConflictException(HistoricOperationEventDto dto) {
        return new ConflictException(Messages.HISTORIC_OPERATION_EVENT_ALREADY_EXISTS, dto.getProcessId(), dto.getPrimaryKey());
    }
