...
public class OperationDtoDao extends AbstractDtoDao<OperationDto, String> {
    ...
    @Override
    protected NotFoundException getNotFoundException(String processId) {
        return new NotFoundException(Messages.OPERATION_NOT_FOUND, processId);
    }

    @Override
    protected ConflictException getConflictException(OperationDto operation) {
        String processId = operation.getPrimaryKey();
        return new ConflictException(Messages.OPERATION_ALREADY_EXISTS, processId);
    }
