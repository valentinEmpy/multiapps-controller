...
public class DeployedMtaEnvDetector {
    ...
    private DeployedMta toDeployedMta(String mtaId, List<CloudApplication> applications) {
        ...
        for (CloudApplication application : applications) {
            DeployedMtaApplication module = envMtaMetadataParser.parseDeployedMtaApplication(application);
            apps.add(module);
            services.addAll(toDeployedMtaServices(module.getBoundMtaServices()));
        }
    ...
    private List<DeployedMtaService> toDeployedMtaServices(List<String> serviceNames) {
